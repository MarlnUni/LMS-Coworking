...
export const users = [
  ...
  { id: 2, name: 'Bob Manager', role: 'manager', manager_id: 1, instructor_flag: true, username: 'manager', password: 'manager123' }, // manager-level learner
  { id: 3, name: 'Carol Manager', role: 'manager', manager_id: 1, instructor_flag: true, username: 'manager2', password: 'manager2123' },
  { id: 4, name: 'Dave Manager', role: 'manager', manager_id: 2, instructor_flag: false, username: 'manager3', password: 'manager3123' },
  { id: 5, name: 'Eve Manager', role: 'manager', manager_id: 2, instructor_flag: false, username: 'manager4', password: 'manager4123' },
  { id: 6, name: 'Frank Manager', role: 'manager', manager_id: 3, instructor_flag: false, username: 'manager5', password: 'manager5123' },
  ...
  { id: 11, name: 'Dr. Sarah Instructor', role: 'instructor', manager_id: 1, instructor_flag: true, username: 'instructor', password: 'instructor123' }, // dedicated instructor
]; 